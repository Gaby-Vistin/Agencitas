        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetailItem('Email', patient.email ?? 'Sin email'),
              if (patient.phoneMobile != null)
                _buildDetailItem('Celular', patient.phoneMobile!),
              if (patient.phoneConventional != null)
                _buildDetailItem('Teléfono Convencional', patient.phoneConventional!),
